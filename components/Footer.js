    ...
    <footer className="mt-12 border-t bg-white">
      <div className="container py-10 text-sm text-[var(--muted)]">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div>
            <div className="font-semibold text-[var(--farmBrown)]">Olas Farm</div>
        ...
        <div className="mt-6 text-xs text-[var(--muted)]">© {new Date().getFullYear()} Olas Farm. All rights reserved.</div>
      </div>
    </footer>
  )
}
